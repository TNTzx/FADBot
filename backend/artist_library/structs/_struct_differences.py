...
live arena events with 15K spectators.''',
		...
		'details': {
			'socials': [
				{
					'link': 'https://www.youtube.com/channel/UCa_UMppcMsHIzb5LDx1u9zQ',
					'type': 'youtube'
				},
				{
					'link': 'https://www.facebook.com/thisisthefatrat',
					'type': 'facebook'
				},
				{
					'link': 'https://open.spotify.com/artist/3OKg7YbOIatODzkRIbLJR4',
					'type': 'spotify'
				},
				{
					'link': 'https://music.apple.com/artist/thefatrat/395664545',
					'type': 'itunes'
				},
				{
					'link': 'https://twitter.com/ThisIsTheFatRat',
					'type': 'twitter'
				}
			]
		}
